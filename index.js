const provincia = document.getElementById("provinces");
const ciudad = document.getElementById("town");
const hoy = document.getElementById("today");
const mañana = document.getElementById("tomorrow");
const lugar = document.getElementById("site");
let CODPROV;
  ...
  fetch("https://www.el-tiempo.net/api/json/v2/provincias")
    ...
    .then((json) => {
      json.provincias.forEach((provincia) => {
        ...
        opcion.append(provincia.NOMBRE_PROVINCIA);
